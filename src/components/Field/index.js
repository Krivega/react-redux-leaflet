...
export default class Field extends React.PureComponent {
  ...
  render() {
    const { type, min, max, step, readOnly, autoFocus, disabled, id, required } = this.props;
    const { value } = this.state;
    let pattern;
    const inputProps = { type, min, max, step, value, readOnly, autoFocus, disabled, id, required };
